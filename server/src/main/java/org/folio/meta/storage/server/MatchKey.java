package org.folio.meta.storage.server;
...
public class MatchKey {
  ...
  private final Logger logger = LoggerFactory.getLogger("reshare-index");
    ...
    if (candidateInstance.containsKey("classifications")) {
      ...
      for (Object o : classificationList) {
        ...
        if (classification.containsKey("classificationTypeId")
                && classification.getString("classificationTypeId")
                .equals("9075b5f8-7d97-49e1-a431-73fdd468d476")) {
